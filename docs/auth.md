...
| `hebbian_enabled` | bool | — | Enable/disable Hebbian co-activation learning. Symmetric (COG-31): gates weight updates, association decay, **and** the read-side boost recall applies from association weights |
