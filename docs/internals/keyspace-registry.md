...
| **0x2F** | ws+sha256(32) | engramID(16) | upsert forward-index — `idempotent_id` → engram pin (#556); relocated from 0x2D after #694 allocated ProspectiveIntent (0x2D) |
...
index (THE PUSH #694), 0x2F upsert forward-index (#556);
