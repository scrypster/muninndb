...
can separate nonsense from genuine matches. Measured on a real 3,296-memory production
...
**Real magnitudes for N=3,296 (production vault):**
...
Against the labs clone (isolated daemon, REST :9475, vault=<production>, 3,296 real
