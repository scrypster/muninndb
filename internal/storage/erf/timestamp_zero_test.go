...
// surgical: any timestamp a real writer can produce still round-trips to the
// same nanosecond. The sentinel value is unreachable for a legitimate time —
// UnixNano is only defined for 1678..2262 — so no in-range value can collide.
