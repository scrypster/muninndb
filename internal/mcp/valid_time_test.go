...
func (e *validityCapturingEngine) Evolve(_ context.Context, vault, oldID, newContent, reason string, embedding []float32, concept string, entities []mbp.InlineEntity, effectiveAt time.Time) (*WriteResult, error) {
